...
If you don't want to build from the source, there's a [prebuilt version of the plugin available](http://www.pocketsoap.com/osx/jenkins/ChatterPlugin.hdi.zip).
